...
## Instructions
<section id="instructions"> O Camper Cat é tanto um codificador ninja, como também é um ninja de verdade, e está construindo um site para compartilhar seu conhecimento. A foto do perfil que ele quer usar mostra suas habilidades e deve ser apreciada por todos os visitantes do site. Adicione um atributo <code>alt</code> na tag <code>img</code> , que explica que o Camper Cat está praticando karatê. (A imagem <code>src</code> não tem link para um arquivo real, então você deve ver o <code>alt</code> do texto na tela.) </section>
